...
def plot_results(file_name, file_name2, file_name3):
...
if __name__ == '__main__':
    file_name = os.listdir('../results')[0]
    file_name2 = os.listdir('../results')[1]
    file_name3 = os.listdir('../results')[2]

    plot_results(file_name, file_name2, file_name3)
